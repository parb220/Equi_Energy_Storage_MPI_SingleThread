...
test_GMM_mpi_obj = test_GMM_mpi.o mpi_master_single_thread.o  mpi_slave_single_thread.o DispatchBurnInTask.o DispatchTuningTask.o DispatchSimulationTask.o DispatchTrackingTask.o DispatchSimulationTask_LevelByLevel.o $(SINGLE_CORE_VERSION_OBJS) $(DISTR_MODEL_OBJS)
...
DispatchSimulationTask.o: DispatchSimulationTask.cpp
	$(MPICXX) $(CFLAGS) $(INCLUDE_DIR) -c DispatchSimulationTask.cpp
